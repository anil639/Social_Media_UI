  ...
  return (
    <div>
      <svg
        ...
        width="16"
        height="16.892"
        viewBox="0 0 16 16.892"
      >
        <path
          id="Path_27"
          data-name="Path 27"
          d="M6.852,16.465H3.392a2.046,2.046,0,0,1-2.038-2.031V7.553a1.271,1.271,0,0,1,.459-.97l.609-.451A.677.677,0,0,0,1.64,5.055h0l-.624.466A2.617,2.617,0,0,0,0,7.553v6.889a3.4,3.4,0,0,0,3.392,3.392h3.46a.677.677,0,1,0,0-1.354Z"
  ...
  return (
    <div>
      <svg
        ...
        width="15.52"
        height="13.768"
        viewBox="0 0 15.52 13.768"
      >
        <path
          id="heart"
          d="M16.093,4.579a4.882,4.882,0,0,0-6.334-.5,4.867,4.867,0,0,0-6.334,7.358l4.82,4.828a2.158,2.158,0,0,0,3.027,0l4.82-4.828A4.867,4.867,0,0,0,16.093,4.579ZM15,10.37l-4.82,4.82a.59.59,0,0,1-.838,0L4.52,10.346A3.293,3.293,0,0,1,9.177,5.689a.776.776,0,0,0,1.1,0A3.315,3.315,0,0,1,15,10.346Z"
  ...
  return (
    <div>
      <svg
        ...
        width="17.778"
        height="15"
        viewBox="0 0 17.778 15"
      >
        <path
          id="message"
          d="M12.62,0a5.193,5.193,0,0,1,5.158,5.2h0V6.5l-.006.086a.631.631,0,0,1-.623.548h0l-.008-.016-.1-.008a.628.628,0,0,1-.346-.178.636.636,0,0,1-.184-.448h0V5.2A3.946,3.946,0,0,0,12.62,1.275H5.158A3.946,3.946,0,0,0,1.266,5.2h0V9.8a3.946,3.946,0,0,0,3.892,3.921H12.62A3.946,3.946,0,0,0,16.512,9.8a.636.636,0,0,1,1.266,0A5.193,5.193,0,0,1,12.62,15H5.158A5.185,5.185,0,0,1,0,9.8H0V5.2A5.177,5.177,0,0,1,5.158,0H12.62Z"
          fill="#8d8d8d"
        />
      </svg>
    </div>
  ...
  return (
    <div>
      <svg
        ...
        width="16.209"
        height="17.2"
        viewBox="0 0 16.209 17.2"
      >
        <g id="setting" transform="translate(-0.073 -0.178)">
          <path
            id="Path_33"
            data-name="Path 33"
            d="M15.369,5.228l-.518-.9a1.592,1.592,0,0,0-2.171-.587h0a1.585,1.585,0,0,1-2.171-.564,1.525,1.525,0,0,1-.213-.762h0A1.592,1.592,0,0,0,8.7.778H7.658A1.585,1.585,0,0,0,6.073,2.37h0A1.592,1.592,0,0,1,4.481,3.94a1.524,1.524,0,0,1-.762-.213h0a1.592,1.592,0,0,0-2.171.587l-.556.914A1.592,1.592,0,0,0,1.571,7.4h0a1.592,1.592,0,0,1,0,2.758h0a1.585,1.585,0,0,0-.579,2.164h0l.526.907a1.592,1.592,0,0,0,2.171.617h0a1.577,1.577,0,0,1,2.164.579,1.524,1.524,0,0,1,.213.762h0a1.592,1.592,0,0,0,1.592,1.592H8.7a1.592,1.592,0,0,0,1.592-1.585h0A1.585,1.585,0,0,1,11.887,13.6a1.622,1.622,0,0,1,.762.213h0a1.592,1.592,0,0,0,2.171-.579h0l.549-.914a1.585,1.585,0,0,0-.579-2.171h0a1.585,1.585,0,0,1-.579-2.171A1.562,1.562,0,0,1,14.79,7.4h0a1.592,1.592,0,0,0,.579-2.164h0Z"
